...
function kmdrupal_profile_details() {
  return array(
    'name' => 'kmdrupal',
    'description' => 'Installation profile with KmData modules and demonstration features.'
  );
}
 ...
 *   task list.
 */
function kmdrupal_profile_task_list() {
}
 ...
 */
function kmdrupal_profile_tasks(&$task, $url) {
 ...
 */
function kmdrupal_form_alter(&$form, $form_state, $form_id) {
